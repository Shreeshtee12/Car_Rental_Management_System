...
public class AddRatingController implements ActionListener {
    AddRantingPanel rantingPanel;
    private DAO<Rating> rantingDAO;
    public AddRatingController(final AddRantingPanel rantingPanel){
    ...
    public void actionPerformed(ActionEvent e) {
       if(e.getSource() == this.rantingPanel.getClientSearchButton()){
           ...
           if(
               ...
               rantingDAO.create(new Rating(0,
